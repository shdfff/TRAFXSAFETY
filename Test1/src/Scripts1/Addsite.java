...
public static void main(String[] args) throws Exception {
       ...
       driver.findElement(By.id("new-site-street1")).sendKeys("NYC1 Streeb12");
       driver.findElement(By.id("new-site-street2")).sendKeys("NYC2 Streetc21");
       ...
       sign_in.click();
       Thread.sleep(2000);
       driver.findElement(By.id("search-input")).sendKeys("123rd street");
